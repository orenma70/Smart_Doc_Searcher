...
def initialize_all_clients():
    ...
    # CRITICAL FIX: Include vision_client in the global declaration
    ...
    # 2. Initialize Vision Client (for OCR)
    if vision_client is None:
        # Correctly assigns the Vision client to the vision_client variable
        vision_client = get_vision_client()

        # 3. Initialize Gemini Client (for RAG summary)
